...
void print_summary() {
    ...
    cout << "The total database size is " << db_size_mb << "Mbytes." << endl;
    ...
    cout << endl;
    cout << "         Total offline query size (Kbytes): " << total_offline_size_kb/1024 << endl;
    cout << "                  First dimension (Kbytes): " << dim0_query_size_kb/1024 << endl;
    cout << "       Total for other dimensions (Kbytes): " << dim1s_query_size_kb/1024 << endl;
    cout << "          Total online query size (Kbytes): " << total_query_size_kb/1024 << endl;
    cout << "                    Response size (Kbytes) : " << total_resp_size_kb/1024  << endl;
    cout << endl;
    cout << endl;
    cout << "Database-independent computation" << endl;
    cout << endl;
    cout << "              Main expansion  (CPU·ms): " << time_expansion_main/1000 << endl;
    cout << "  Further dimension expansion (CPU·ms): " << time_expansion_further/1024 << endl;
    cout << "                   Conversion (CPU·ms): " << time_conversion/1024 << endl;
    cout << "                        Total (CPU·ms): " << (time_expansion_main + time_expansion_further + time_conversion)/1024 << endl;
    cout << endl;
    cout << "Database-dependent computation" << endl;
    cout << endl;
    cout << "     First dimension multiply (CPU·ms): " << time_first_multiply/1024 << endl;
    cout << "                      Folding (CPU·ms): " << time_folding/1024 << endl;
    cout << "                        Total (CPU·ms): " << (time_first_multiply + time_folding)/1024 << endl;
    cout << endl;
    cout << "Client computation" << endl;
    cout << endl;
    cout << "               Key generation (CPU·ms): " << time_key_gen/1024 << endl;
    cout << "             Query generation (CPU·ms): " << time_query_gen/1024 << endl;
    cout << "                     Decoding (CPU·ms): " << time_decoding/1024 << endl;
    cout << endl;    
}
